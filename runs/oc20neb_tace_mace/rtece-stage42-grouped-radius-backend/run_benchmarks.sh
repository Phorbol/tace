#!/bin/bash
#SBATCH --job-name=rtece-grouped-radius
...
#SBATCH --output=/home/gengjianrui/bin/logs/rtece-grouped-radius-%j.out
#SBATCH --error=/home/gengjianrui/bin/logs/rtece-grouped-radius-%j.err
...
OUT=runs/oc20neb_tace_mace/rtece-stage42-grouped-radius-backend
