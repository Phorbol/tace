#!/bin/bash
#SBATCH --job-name=rtece-chunk-sweep
...
#SBATCH --output=/home/gengjianrui/bin/logs/rtece-chunk-sweep-%j.out
#SBATCH --error=/home/gengjianrui/bin/logs/rtece-chunk-sweep-%j.err
...
OUT=runs/oc20neb_tace_mace/rtece-stage45-chunk-size-sweep
