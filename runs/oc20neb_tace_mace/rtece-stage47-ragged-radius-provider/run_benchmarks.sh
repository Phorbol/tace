#!/bin/bash
#SBATCH --job-name=rtece-ragged-radius
...
#SBATCH --output=/home/gengjianrui/bin/logs/rtece-ragged-radius-%j.out
#SBATCH --error=/home/gengjianrui/bin/logs/rtece-ragged-radius-%j.err
...
OUT=runs/oc20neb_tace_mace/rtece-stage47-ragged-radius-provider
