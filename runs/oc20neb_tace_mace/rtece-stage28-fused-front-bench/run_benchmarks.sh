#!/bin/bash
#SBATCH --job-name=rtece-fused-front
...
#SBATCH --output=/home/gengjianrui/bin/logs/rtece-fused-front-%j.out
#SBATCH --error=/home/gengjianrui/bin/logs/rtece-fused-front-%j.err
...
OUT=runs/oc20neb_tace_mace/rtece-stage28-fused-front-bench
...
MODE=analytic_element_triton_descriptor_force
