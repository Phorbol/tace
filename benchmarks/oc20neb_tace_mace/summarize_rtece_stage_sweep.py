...
def row_from_index_and_benchmark(
    ...
    *,
    ...
    item: dict[str, Any] = {
        ...
        "dft_relative_energy_errors_available": None,
        "dft_energy_decomposition_metric_schema_version": None,
        "dft_relative_image_rmse_mev_atom": None,
        "dft_relative_image_mae_mev_atom": None,
        "dft_relative_image_max_abs_mev_atom": None,
        "dft_barrier_rmse_mev_atom": None,
        "dft_barrier_mae_mev_atom": None,
        "dft_barrier_max_abs_mev_atom": None,
        "dft_group_mean_offset_rmse_mev_atom": None,
        "dft_group_mean_offset_mae_mev_atom": None,
        "dft_group_mean_offset_max_abs_mev_atom": None,
        "dft_first_image_anchor_rmse_mev_atom": None,
        "dft_first_image_anchor_mae_mev_atom": None,
        "dft_first_image_anchor_max_abs_mev_atom": None,
    ...
    item.update(
        {
            ...
            "dft_relative_energy_errors_available": benchmark.get("relative_energy_errors_available"),
            "dft_energy_decomposition_metric_schema_version": benchmark.get("energy_decomposition_metric_schema_version"),
            "dft_relative_image_rmse_mev_atom": _finite_float(benchmark.get("relative_image_rmse_mev_atom")),
            "dft_relative_image_mae_mev_atom": _finite_float(benchmark.get("relative_image_mae_mev_atom")),
            "dft_relative_image_max_abs_mev_atom": _finite_float(benchmark.get("relative_image_max_abs_mev_atom")),
            "dft_barrier_rmse_mev_atom": _finite_float(benchmark.get("barrier_rmse_mev_atom")),
            "dft_barrier_mae_mev_atom": _finite_float(benchmark.get("barrier_mae_mev_atom")),
            "dft_barrier_max_abs_mev_atom": _finite_float(benchmark.get("barrier_max_abs_mev_atom")),
            "dft_group_mean_offset_rmse_mev_atom": _finite_float(benchmark.get("group_mean_offset_rmse_mev_atom")),
            "dft_group_mean_offset_mae_mev_atom": _finite_float(benchmark.get("group_mean_offset_mae_mev_atom")),
            "dft_group_mean_offset_max_abs_mev_atom": _finite_float(benchmark.get("group_mean_offset_max_abs_mev_atom")),
            "dft_first_image_anchor_rmse_mev_atom": _finite_float(benchmark.get("first_image_anchor_rmse_mev_atom")),
            "dft_first_image_anchor_mae_mev_atom": _finite_float(benchmark.get("first_image_anchor_mae_mev_atom")),
            "dft_first_image_anchor_max_abs_mev_atom": _finite_float(benchmark.get("first_image_anchor_max_abs_mev_atom")),
...
def format_markdown(payload: dict[str, Any]) -> str:
    ...
    for row in payload.get("rows", []):
        lines.append(
            "| {name} | {status} | {params} | {axes} | {atoms} | {frmse} | {fmae} | {fmax} | {ermse} | {emae} | {ebias} | {emax} | {rel_rmse} | {barrier_rmse} | {case_offset_rmse} | {first_anchor_rmse} |".format(
                name=row.get("name"),
